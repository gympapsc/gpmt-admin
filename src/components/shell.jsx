        ...
        <div className="flex flex-col absolute top-0 bottom-0 w-full bg-gray-200">
            ...
            <main className="flex-grow flex flex-row w-full">
                <aside className="py-4 w-14 flex-grow-0 flex flex-col bg-gray-100 border-r border-gray-300 text-gray-700">
                    <Link href="/">
                        <a title="Übersicht" className="flex justify-center items-center transform scale-125 my-4 hover:text-gray-900">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <Link href="/data">
                        <a title="Daten" className="flex justify-center items-center transform scale-125 my-4 hover:text-gray-900">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <Link href="/photos">
                        <a title="Bilder" className="flex justify-center items-center transform scale-125 my-4 hover:text-gray-900">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <Link href="/questionnaire">
                        <a title="Fragebogen" className="flex justify-center items-center transform scale-125 my-4 hover:text-gray-900">    
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <a title="Rasa X" target="_blank" href="http://rasa-x.example.com" className="flex justify-center items-center transform scale-125 my-4 hover:text-gray-900">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <Link href="/settings">
                        <a title="Einstellungen" className="mt-auto flex justify-center items-center transform scale-125 my-4 hover:text-gray-900">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
