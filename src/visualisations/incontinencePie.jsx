...
import { useIncontinenceStats } from "../hooks"

const IncontinencePie = ({ xlabel, ylabel }) => {
    let element = useRef(null)

    let stats = useIncontinenceStats()
    ...
    useEffect(() => {
        ...
        svg
            ...
            .append('path')
            .attr('d', arc)
            .attr('fill', function(d){ return(color(d.data.ms)) })
            .attr("stroke", "white")
        ...
        svg
            ...
            .enter()
            .append('text')
                .text( function(d) { console.log(d.data.ms) ; return d.data.ms } )
...
export default IncontinencePie